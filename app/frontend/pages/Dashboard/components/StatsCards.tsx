  ...
  return (
    <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
      ...
      <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-green-100/50 hover:shadow-xl transition-shadow duration-200">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium text-green-900">Siswa Sedang Muraja'ah Hari Ini</CardTitle>
        ...
        <CardContent>
          ...
          <p className="text-xs text-green-700/70 mt-1">Siswa aktif berlatih ulang kaji</p>
        </CardContent>
      </Card>
      ...
      <Card className="border-0 shadow-lg bg-gradient-to-br from-orange-50 to-orange-100/50 hover:shadow-xl transition-shadow duration-200">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium text-orange-900">Siswa Sedang Menghafal Hari Ini</CardTitle>
        ...
        <CardContent>
          ...
          <p className="text-xs text-orange-700/70 mt-1">Siswa aktif menghafal ayat baru</p>
        </CardContent>
      </Card>
    </div>
